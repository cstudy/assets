/*!
 * Last modified: 2021/06/15 10:32:10
          ...
          for (var key in groups) {
            ...
            if (data_set.id != null) {
              if (showParents && data_set.is_parent) {
                output +=
                '<tr class="tg_sort_tr tg_is_parent" data-position="' + position + '">\n';
                output += '<td>' + data_set.id + '</td>\n';
                output +=
                '<td class="tg_label_column"><div class="tg_edit_label tg_text tg_truncate" data-position="' +
                position +
                '" data-label="' +
                escape_html(data_set.label) +
                '">';
                output += escape_html(data_set.label) +
                ...
                output += escape_html(data_set.label) +
                  '<span class="dashicons dashicons-edit tg_pointer" style="display:none;"></span></div></td>\n';
                if (dataParsed.supplemental.parents_available) {
                  output += '<td class="tg_hide_when_drag"><div class="tg_truncate">' + data_set.parent_label + '</div></td>\n';
                }
                output +=
              ...
              output += outputFilters ? '<td class="tg_hide_when_drag">' + outputFilters + '</td>\n' : '';
