...
function theme_autoload()
{
    if (!is_admin()) {
        ...
        wp_enqueue_style('my_custom_style', 'https://cdn.jsdelivr.net/gh/cstudy/assets@develop/wordpress/themes/kratos/assets/css/custom_style.css', array(), '07120118');
        ...
        wp_enqueue_script('kratos', 'https://cdn.jsdelivr.net/gh/cstudy/assets@develop/wordpress/themes/kratos/assets/js/kratos.js', array(), THEME_VERSION, true);
